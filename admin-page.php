                ...
                <div class="section-title">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="text-center line-height-1 mt-0">GESTION<span class="text-theme-colored3"> ADMINISTRATION</span></h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row equal-height">
                        <div class="col-sm-4 col-md-4">
                            <div class="icon-box-new bg-white text-center clearfix m-0 pr-20 pl-20 pt-30 pb-20 mb-40">
                                ...
                                <h3 class="icon-box-title mt-5 mb-15 letter-space-1 line-height-1">Cours</h3>
                        ...
                        <div class="col-sm-4 col-md-4">
                            <div class="icon-box-new bg-white text-center clearfix m-0 pr-20 pl-20 pt-30 pb-20 mb-40">
                                ...
                                <h3 class="icon-box-title mt-5 mb-15 letter-space-1 line-height-1">Etudiant</h3>
                                <a class="text-black-999" href="#">Read More...</a>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4">
                            <div class="icon-box-new bg-white text-center clearfix m-0 pr-20 pl-20 pt-30 pb-20 mb-40">
                                ...
                                <h3 class="icon-box-title mt-5 mb-15 letter-space-1 line-height-1">Paiement</h3>
                                <a class="text-black-999" href="#">Read More...</a>
                            </div>
                        </div>
                    </div>
